// Talent Bank is a special job with a fixed UUID in the database
// This UUID is used for routing and database references
export const TALENT_BANK_JOB_ID = "00000000-0000-0000-0000-000000000001";

export const TALENT_BANK_DESCRIPTION = `### Sobre a Popcode
...
Promovemos um ambiente humanizado, que valoriza a colaboração e a autonomia para fazer acontecer!

E para estimular o seu bem-estar e desenvolvimento, a Popcode oferece:
